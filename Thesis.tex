...
\usepackage[colorlinks=true,
  ...
  menucolor=black,
  runcolor=black,
  urlcolor=black]{hyperref} % Adds clickable links at references
\usepackage{cleveref}
% \usepackage[square, numbers, sort&compress]{natbib} % Square brackets, citing references with numbers, citations sorted by appearance in the text and compressed
\usepackage[backend=biber,
            style=ieee]{biblatex}
\addbibresource{Thesis_bibliography.bib} % The references information are stored in the file named "Thesis_bibliography.bib"
...
\puttitle{
  ...
  advisor = Prof. ssa Chiara Venegoni,                       % Supervisor name
  % coadvisor={Name Surname, Name Surname},                  % Co-Supervisor name, remove this line (and look for "coadvisors" in `polimi3i_thesis.cls`) if there is none

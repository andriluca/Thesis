...
@mtkmodel Airway begin
    ...
    @components begin
        ...
        r_tube_1 = CIDResistor(Ra    = ParentScope(Ra),
                               Rl    = ParentScope(Rl),
                               V_FRC = ParentScope(V_FRC))
        # Condensatori
        c_g      = Capacitor()
        ...
        i_tube   = CIDInductor(La = ParentScope(La),
                               Ll = ParentScope(Ll),
                               V_FRC = ParentScope(V_FRC))
        i_tube_1 = CIDInductor(La = ParentScope(La),
                               Ll = ParentScope(Ll),
                               V_FRC = ParentScope(V_FRC))
        ground   = Ground()
    end
...
sys_ps = [
    ...
    system.IAE.Rl     => 3.109214e+02 + 1.518509e+04,
    system.IAE.V_FRC  => 3.642283e-07,
    ## Itube
    system.IAE.La     => 6.440085e-03,
    system.IAE.Ll     => 6.440085e-03 + 5.718839e+00,
    ...
    system.IAG.Rl     => 4.012746e+02 + 1.959785e+04,
    system.IAG.V_FRC  => 2.699475e-07,
    ## Itube
    system.IAG.La     => 6.908560e-03,
    system.IAG.Ll     => 6.908560e-03 + 6.134848e+00,
    ...
    system.IAI.Rl     => 4.759710e+02 + 2.324594e+04,
    system.IAI.V_FRC  => 2.198790e-07,
    ## Itube
    system.IAI.La     => 7.229610e-03,
    system.IAI.Ll     => 7.229610e-03 + 6.419942e+00,
    ...
    system.IBA.Rl     => 2.017423e+02 + 9.852891e+03,
    system.IBA.V_FRC  => 5.958497e-07,
    ## Ltube
    system.IBA.La     => 5.687354e-03,
    system.IBA.Ll     => 5.687354e-03 + 5.050408e+00,
    ...
    system.IBB.Rl     => 2.282920e+02 + 1.114955e+04,
    system.IBB.V_FRC  => 5.185713e-07,
    ## Itube
    system.IBB.La     => 5.896531e-03,
    system.IBB.Ll     => 5.896531e-03 + 5.236159e+00,

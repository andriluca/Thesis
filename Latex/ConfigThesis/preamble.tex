...
\tikzstyle{airway} = [rectangle, rounded corners, minimum width=1.5cm, text width=.75cm, minimum height=.75cm, text centered, draw=black, fill=red!40]
\tikzstyle{acinus} = [rectangle, rounded corners, minimum width=1.5cm, text width=.75cm, minimum height=.75cm, text centered, draw=black, fill=blue!25]
\tikzstyle{arrow1} = [color=gray!80, very thick,->, >=stealth]

\tikzstyle{airway_vertical} = [rectangle, rounded corners, minimum width=1cm, text width=.75cm, minimum height=.75cm, text centered, draw=black, fill=red!40]
\tikzstyle{acinus_vertical} = [rectangle, rounded corners, minimum width=1cm, text width=.75cm, minimum height=.75cm, text centered, draw=black, fill=blue!25]
...
\newcommand{\advisor}{Prof. Raffaele Dellaca'}

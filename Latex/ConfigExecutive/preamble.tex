...
\tikzstyle{airway} = [rectangle, rounded corners, minimum width=1cm, text width=.75cm, minimum height=.5cm, text centered, draw=black, fill=red!30]
\tikzstyle{acinus} = [rectangle, rounded corners, minimum width=1cm, text width=.75cm, minimum height=.5cm, text centered, draw=black, fill=yellow!30]

...
** TODO Aiutare il futuro sviluppatore del sistema mediante `getdescription(var)` :Futuro:Manuale:
...
** TODO [#A] Come posso importare un così gran numero di dati?    :Problema:
* 09.11.23                                                       :Componenti:
...
** TODO Instabilità della sottorete                               :Problema:
